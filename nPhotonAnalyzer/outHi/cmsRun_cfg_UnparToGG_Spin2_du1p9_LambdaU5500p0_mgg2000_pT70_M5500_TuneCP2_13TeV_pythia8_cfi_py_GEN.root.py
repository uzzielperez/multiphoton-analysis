...
if islocal:
    ...
    INFILE    = PATH + 'UnparToGG_Spin2_du1p9_LambdaU5500p0_mgg2000_pT70_M5500_TuneCP2_13TeV_pythia8_cfi_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('UnparToGG_Spin2_du1p9_LambdaU5500p0_mgg2000_pT70_M5500_TuneCP2_13TeV_pythia8_cfi_py_GEN.root')
else:
