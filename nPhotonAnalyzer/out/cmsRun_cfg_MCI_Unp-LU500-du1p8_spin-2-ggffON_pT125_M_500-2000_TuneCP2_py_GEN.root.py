...
if islocal:
    ...
    INFILE    = PATH + 'MCI_Unp-LU500-du1p8_spin-2-ggffON_pT125_M_500-2000_TuneCP2_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('MCI_Unp-LU500-du1p8_spin-2-ggffON_pT125_M_500-2000_TuneCP2_py_GEN.root')
else:
