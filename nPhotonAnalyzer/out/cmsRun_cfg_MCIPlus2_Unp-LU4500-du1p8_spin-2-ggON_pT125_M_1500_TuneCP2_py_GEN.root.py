...
if islocal:
    ...
    INFILE    = PATH + 'MCIPlus2_Unp-LU4500-du1p8_spin-2-ggON_pT125_M_1500_TuneCP2_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('MCIPlus2_Unp-LU4500-du1p8_spin-2-ggON_pT125_M_1500_TuneCP2_py_GEN.root')
else:
