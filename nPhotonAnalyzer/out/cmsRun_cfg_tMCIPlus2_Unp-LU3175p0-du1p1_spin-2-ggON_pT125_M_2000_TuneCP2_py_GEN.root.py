...
if islocal:
    ...
    INFILE    = PATH + 'tMCIPlus2_Unp-LU3175p0-du1p1_spin-2-ggON_pT125_M_2000_TuneCP2_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('tMCIPlus2_Unp-LU3175p0-du1p1_spin-2-ggON_pT125_M_2000_TuneCP2_py_GEN.root')
else:
