...
if islocal:
    ...
    INFILE    = PATH + 'TestADD_NI-1_LambdaT-13000_M-1000_TuneCUEP8M1_13TeV_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('TestADD_NI-1_LambdaT-13000_M-1000_TuneCUEP8M1_13TeV_py_GEN.root')
else:
