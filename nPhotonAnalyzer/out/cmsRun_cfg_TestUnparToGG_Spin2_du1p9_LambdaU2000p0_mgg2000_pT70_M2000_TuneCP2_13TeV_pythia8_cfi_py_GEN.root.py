...
if islocal:
    ...
    INFILE    = PATH + 'TestUnparToGG_Spin2_du1p9_LambdaU2000p0_mgg2000_pT70_M2000_TuneCP2_13TeV_pythia8_cfi_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('TestUnparToGG_Spin2_du1p9_LambdaU2000p0_mgg2000_pT70_M2000_TuneCP2_13TeV_pythia8_cfi_py_GEN.root')
else:
