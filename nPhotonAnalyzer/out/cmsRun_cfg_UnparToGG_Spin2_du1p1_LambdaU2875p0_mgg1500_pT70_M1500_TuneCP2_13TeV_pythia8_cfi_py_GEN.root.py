...
if islocal:
    ...
    INFILE    = PATH + 'UnparToGG_Spin2_du1p1_LambdaU2875p0_mgg1500_pT70_M1500_TuneCP2_13TeV_pythia8_cfi_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('UnparToGG_Spin2_du1p1_LambdaU2875p0_mgg1500_pT70_M1500_TuneCP2_13TeV_pythia8_cfi_py_GEN.root')
else:
