...
if islocal:
    ...
    INFILE    = PATH + 'UnparToGG_Spin2_du1p9_LambdaU2750p0_mgg500_pT70_M2000_TuneCP2_13TeV_pythia8_cfi_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('UnparToGG_Spin2_du1p9_LambdaU2750p0_mgg500_pT70_M2000_TuneCP2_13TeV_pythia8_cfi_py_GEN.root')
else:
