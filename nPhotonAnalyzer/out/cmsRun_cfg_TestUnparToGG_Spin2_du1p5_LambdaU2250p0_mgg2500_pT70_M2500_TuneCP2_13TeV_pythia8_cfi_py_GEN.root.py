...
if islocal:
    ...
    INFILE    = PATH + 'TestUnparToGG_Spin2_du1p5_LambdaU2250p0_mgg2500_pT70_M2500_TuneCP2_13TeV_pythia8_cfi_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('TestUnparToGG_Spin2_du1p5_LambdaU2250p0_mgg2500_pT70_M2500_TuneCP2_13TeV_pythia8_cfi_py_GEN.root')
else:
