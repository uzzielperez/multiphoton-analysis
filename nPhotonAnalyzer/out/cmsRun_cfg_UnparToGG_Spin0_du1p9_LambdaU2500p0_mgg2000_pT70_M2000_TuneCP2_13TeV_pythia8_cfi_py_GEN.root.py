...
if islocal:
    ...
    INFILE    = PATH + 'UnparToGG_Spin0_du1p9_LambdaU2500p0_mgg2000_pT70_M2000_TuneCP2_13TeV_pythia8_cfi_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('UnparToGG_Spin0_du1p9_LambdaU2500p0_mgg2000_pT70_M2000_TuneCP2_13TeV_pythia8_cfi_py_GEN.root')
else:
