...
if islocal:
    ...
    INFILE    = PATH + 'tMCIPlus2_Unp-LU4000-du1p8_spin-2-ggON_pT125_M_2000_TuneCP2_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('tMCIPlus2_Unp-LU4000-du1p8_spin-2-ggON_pT125_M_2000_TuneCP2_py_GEN.root')
else:
