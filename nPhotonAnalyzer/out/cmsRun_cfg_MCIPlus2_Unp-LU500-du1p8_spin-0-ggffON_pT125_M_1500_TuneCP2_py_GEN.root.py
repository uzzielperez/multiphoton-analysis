...
if islocal:
    ...
    INFILE    = PATH + 'MCIPlus2_Unp-LU500-du1p8_spin-0-ggffON_pT125_M_1500_TuneCP2_py_GEN.root'
    inputFile = 'file:%s' %(INFILE)
    outName = 'Test%s' %('MCIPlus2_Unp-LU500-du1p8_spin-0-ggffON_pT125_M_1500_TuneCP2_py_GEN.root')
else:
