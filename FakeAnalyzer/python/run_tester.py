...
#templatefile = cmssw_base + "/src/multiphoton-analysis/FakeAnalyzer/python/cmsRun_cfg_phoEff_tester.py"
templatefile = cmssw_base + "/src/multiphoton-analysis/FakeAnalyzer/python/cmsRun_cfg_tester.py"
inputFile_ = 'file:'+cmssw_base+'/src/localDatasets/GGGJets_TuneCUETP8M1_13TeV_madgraphMLM_pythia8_spring.root'
outputFile_ = "GGGJets_TuneCUETP8M1_13TeV_madgraphMLM_pythia8_RunIIFall17MiniAODv2_PhotonEfficiency.root"
nevts = 13433

# inputFile_ = 'file:'+ cmssw_base + '/src/localDatasets/GGJets_M60To200_Pt50_13TeV-sherpa_RunIIFall17MiniAODv2.root'
